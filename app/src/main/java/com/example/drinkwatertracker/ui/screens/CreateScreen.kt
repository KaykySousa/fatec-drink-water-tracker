...
@Composable
fun CreateScreen(navController: NavHostController, viewModel: HydrationCreateViewModel = viewModel(factory = AppViewModelProvider.Factory)) {
